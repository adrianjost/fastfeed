    ...
    <section id="aboutcard" class="hidden">
        <div class="card-panel single-card fullarticle">
            ...
            <div class="content">
                ...
                <p>And Yes, <i>Fast</i><b>Feed</b> is Open-Source!</br>Checkout here: <a href="https://github.com/adrianjost/fastfeed" target="_blank" rel="noopener">Github</a></p>
        ...
        <div class="card-panel single-card fullarticle">
            ...
            <div class="content">
                ...
                <table>
                    <tr>
                        <td>primarycolor</td>
                        <td><input id="primarycolor-picker" type="color" value="#00d49f" style="width:50px;"></td>
                        <td id="primarycolor">#00d49f</td>
                    </tr>
                    <tr>
                        <td>accentcolor</td>
                        <td><input id="accentcolor-picker" type="color" value="#fac532" style="width:50px;"></td>
                        <td id="accentcolor">#fac532</td>
                    </tr>
                    <tr>
                        <td>Close Card on Click</td>
                        <td><input id="close_by_click-picker" type="checkbox" value="true"></td>
                    </tr>
                </table>
            </div>
        </div>
