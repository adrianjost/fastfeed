...
class Readability
{
	...
	**/
	protected function grabArticle($page=null) {
		...
		* TODO [#67]: Shouldn't this be a reverse traversal?
		**/
		$node = null;
		$nodesToScore = array();
		...
		//for ($nodeIndex=$targetList->length-1; $nodeIndex >= 0; $nodeIndex--) {
			...
			if ($tagName == 'DIV') {
				...
				{
					/* EXPERIMENTAL */
					// TODO [#68]: change these p elements back to text nodes after processing
		...
		**/
		...
		{
			// TODO [#69]: find out why element disappears sometimes, e.g. for this URL http://www.businessinsider.com/6-hedge-fund-etfs-for-average-investors-2011-7
	...
	*/
	public function cleanConditionally($e, $tag) {
		...
		*
		* TODO [#70]: Consider taking into account original contentScore here.
		*/
